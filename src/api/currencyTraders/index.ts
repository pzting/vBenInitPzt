...
enum Api {
   ...
   *内容:币商用户列表
   **/
  userDealPageListUserApi = "/userDeal/pageListUser",
  userDealAddScoreApi = "/userDeal/addScore",
}
 ...
 *内容:币商用户列表
 **/
export const userDealPageListUser = (params) =>
  defHttp.post({ url: Api.userDealPageListUserApi, params });
export const userDealAddScore = (params) =>
  defHttp.post({ url: Api.userDealAddScoreApi, params });
