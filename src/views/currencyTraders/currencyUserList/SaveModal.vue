...
import { saveModalFormSchema } from "./index.data";
import { contractRateList, getDeptList } from "/@/api/currencyTraders";
...
export default defineComponent({
  ...
  setup(_, { emit }) {
    ...
    const getTitle = computed(() => (!unref(isUpdate) ? t("basic.add") : t("basic.edid")));
