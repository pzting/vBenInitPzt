export default {
  ...
  app: { logoutTip: 'अनुस्मारक', logoutMessage: 'बाहर निकलने की प्रणाली की पुष्टि करना है या नहीं?', menuLoading: 'मेनू लोड...' },
  errorLog: {
    tableTitle: '错误日志列表',
    tableColumnType: '类型',
    tableColumnDate: '时间',
  ...
  login: {
    ...
    signInDesc: 'उपयोग शुरू करने के लिए अपना व्यक्तिगत विवरण दर्ज करें！',
    policy: '我同意xxx隐私政策',
    ...
    loginSuccessDesc: 'वापसी पर स्वागत है',

    // placeholder
    accountPlaceholder: 'कृपया इनपुट उपयोगकर्ता नाम',
